...
class ProductApiController extends Controller
{
    ...
    {
        $products =  Product::with('images', 'vendor')->where('popular',1)->get();
    ...
    public function categoryWiseProduct(Request $request)
    {
        ...
        $products = Product::with('images')->where('category_id', $request->category_id)->get();
...
//            $products[$i] = $prod;
    ...
    public function searchProduct(Request $request)
    {
        ...
        $products = Product::with('images', 'vendor')

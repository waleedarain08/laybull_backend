@extends('layouts.app', ['page' => __('Grocery Order Details'), 'pageSlug' => 'grocerybooking'])
<style>
.smallDiv{
    margin-right: 8%;
    width: 40% !important;
...
@section('content')
        <div class="row">
            ...
            <div class="card ">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="title">{{ __('Grocery Booking Details ') }}</h5>
                    </div>
                    <div class="table-reponsive">
                        <table class="table tablesorter" id="">
                            <thead class="text-primary">
                            <tr>
                            <th>Grocery_Booking_ID</th>
                            <th>Quantity</th>
                            <th>Grocery Name</th>
                            <th>Vendor_ID</th>
                            <th>Vendor_Name</th>

@extends('layouts.app', ['page' => __('Grocery Booking'), 'pageSlug' => 'grocerybooking'])
@section('content')
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="title">{{ __('Grocery Booking ') }}</h5>
                    ...
                    <div class="table-reponsive">
                        ...
                        <tbody>
                            ...
                            <td><a href="{{route('grocerybooking.show',['grocerybooking' => $record->id])}}">Order</a></td>
                            </tr>   
                            @endforeach
                        </tbody>
                    </table>

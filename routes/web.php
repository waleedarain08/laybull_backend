...
// 		Route::get('grocerydetails','GroceryBookingController@grocerydetails')->name('grocerydetails');
    ...
    Route::get('orders/{id}/dispatch', 'ShipmentController@dispatch');
 Route::get('orders','ShipmentController@index')->name('orders.index');
 Route::get('orders/{id}/detail','ShipmentController@order_detail')->name('orders.detail');

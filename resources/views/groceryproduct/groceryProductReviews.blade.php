@extends('layouts.app', ['page' => __('Grocery Product Reviews'), 'pageSlug' => 'groceryproductreviews'])
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card ">
               @include('alert2.message')
                <div class="card-header">
                    <h5 class="title">{{ __('Grocery Product Reviews') }}</h5>
                ...
                <div class="table-reponsive">
                    <table class="table tablesorter" id="">
                        ...
                        <tr>
                        <td>{{$records->groceryproduct->name}}</td>
                        ...
                        @if(auth()->user()->role=='admin')
                        <td>{{$records->groceryproduct->user->id}}</td>
                        <td>{{$records->groceryproduct->user->name}}</td>
                        @endif
                       </tr>
                      @endforeach
                      </tbody>

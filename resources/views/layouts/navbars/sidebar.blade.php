        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                 ...
                 <li>
                    <a data-toggle="collapse" href="#orders" aria-expanded="true">
                        <i class="fab fa-product-hunt" ></i>
                        <span class="nav-link-text" >{{ __('Orders') }}</span>
                        <b class="caret mt-1"></b>
                    </a>
                    <div class="{{ $pageSlug == 'orders' ? 'active' : '' }}{{ $pageSlug == 'orders' ? 'collapse.show' : '' }} collapse" id="orders">
                        <ul class="nav pl-4">
                            <li class="{{ $pageSlug == 'orders' ? 'active' : '' }}" style="{{ $pageSlug == 'orders' ? 'background-color:black;' : ''}}">
                ...
                <li>
                    ...
                    <a data-toggle="collapse" href="#countries" aria-expanded="true">
                        <i class="fab fa-product-hunt" ></i>
                        <span class="nav-link-text" >{{ __('Countries') }}</span>
                        <b class="caret mt-1"></b>
                    </a>
                    <div class="{{ $pageSlug == 'countries' ? 'active' : '' }}{{ $pageSlug == 'countries' ? 'collapse.show' : '' }} collapse" id="countries">
                        <ul class="nav pl-4">
                            <li class="{{ $pageSlug == 'countries' ? 'active' : '' }}" style="{{ $pageSlug == 'countries' ? 'background-color:black;' : ''}}">
                 ...
                 <li>
                    <a data-toggle="collapse" href="#discounts" aria-expanded="true">
                        <i class="fab fa-product-hunt" ></i>
                        <span class="nav-link-text" >{{ __('discounts') }}</span>
                        <b class="caret mt-1"></b>
                    </a>
                    <div class="{{ $pageSlug == 'discounts' ? 'active' : '' }}{{ $pageSlug == 'discounts' ? 'collapse.show' : '' }} collapse" id="discounts">
                        <ul class="nav pl-4">
                            <li class="{{ $pageSlug == 'discounts' ? 'active' : '' }}" style="{{ $pageSlug == 'discounts' ? 'background-color:black;' : ''}}">
